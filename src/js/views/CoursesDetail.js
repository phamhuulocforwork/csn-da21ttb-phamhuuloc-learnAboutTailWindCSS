  ...
  async getHtml() {
    ...
    if (lessonsDetail && !studentLessonIds.includes(id)) {
      return `
        ...
        >
          <div class="overflow-hidden rounded-xl w-full flex justify-center">
            <img class="rounded-xl" src="https://img.youtube.com/vi/${lessonsDetail.youtube_id}/0.jpg">
          </div>
          <div class="relative">
            <h1
          ...
          <article class="rounded-lg bg-white p-6 text-base dark:bg-gray-900">
            <div class="mb-2 flex items-center justify-between">
              <div class="flex items-center">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 rounded-full text-gray-900 dark:text-slate-50">
